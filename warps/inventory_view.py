...
import math
from helpers.pom_funcs import all_warp_details


def human_format(num: int):
    """
    Changes long numbers to short form. Eg: 10000 -> 10K
    """
...
def charas_by_rarity_sort(initial_dict: dict):
    ...
    list_of_owned_charas_with_rarity = sorted([(all_warp_details[chara]['rarity'], chara) for chara in list_of_owned_charas], reverse=True)
